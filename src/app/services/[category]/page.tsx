...
const dummyVendors = {
  ...
  catering: [
    ...
    { id: 2, name: 'קייטרינג טעמים', location: 'ארצי', area: 'ארצי', price: '₪₪₪₪', image: '/images/dummy/catering2.jpg' },
    { id: 3, name: 'מטעמי השף', location: 'אזור הדרום', area: 'דרום', price: '₪₪', image: '/images/dummy/catering3.jpg' },
  ],
  music: [
    { id: 1, name: 'DJ רוני', location: 'ארצי', area: 'ארצי', price: '₪₪₪', image: '/images/dummy/dj1.jpg' },
    { id: 2, name: 'להקת הלילה', location: 'אזור המרכז', area: 'מרכז', price: '₪₪₪₪', image: '/images/dummy/band1.jpg' },
    { id: 3, name: 'DJ מיקס מאסטר', location: 'אזור הצפון', area: 'צפון', price: '₪₪', image: '/images/dummy/dj2.jpg' },
  ],
  dresses: [
